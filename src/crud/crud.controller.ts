...
export class CrudController {
  ...
  createSeekerProgress(
    ...
    @Body() data: { progressSubject: string; progressBody: string, progressReflections: string | null},
  ): Promise<any> {
